...
class InventoryTest_GET extends TestCase {
	...
	/**
	  ...
	  *  Calling Method: POST
	  *  Data to post:  [name:'PCHS', description: 'Powell Co. High School', roomID: 'ID’]
	...
	{
		$response = $this->call('POST', 'http://192.168.33.99/api/buildings/3320/rooms/101/inventory');
		...
		$this->assertTrue(isset($this->invt));
