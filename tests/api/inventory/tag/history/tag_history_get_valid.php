...
class Tag_History_GET_valid extends TestCase {

/**
/inventory/tag/history
Description: test get method when there exists several specified resources.
Assumption: there exists several specified resources.
URL: http://192.168.33.99/api//inventory/tag/history 
Calling Method:  GET
Anticipated Result Code: 200
Anticipated Result Datatype: JSON.
Anticipated Result Data: list all check-in resources..
Test Code Source: tests/api//inventory/tag/history/history_GET.php
	...
	{
		$response = $this->call('GET', 'http://192.168.33.99/api//inventory/tag/history ');
